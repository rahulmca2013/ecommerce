...
import { NavLink } from 'react-router-dom'
        export class GlobalNotificationLists extends Component {
        ...
        return (
                <div className="p-grid">
                    <div className="p-col-12">
                        <div className="card card-w-title">
                            <h1>Global Notification Lists</h1>
                            <DataTable value={this.props.dataTableValue} paginatorPosition="both" selectionMode="single" header="" paginator={true} rows={10}
                                ...
                                <Column className="sent_date" field="createdDate" header="Sent Date"  sortable={true}/>
            ...
            const mapStateToProps = state => {
                return {
                    ...
                    dataTableValue: state.globalNotificationReducer.gridData
            ...
            const mapDispatchToProps = dispatch => {
                return {
                    onRequestPageLoad: () => dispatch(actions.notificationLists())
                };
            };
            export default connect(mapStateToProps, mapDispatchToProps)(GlobalNotificationLists);
