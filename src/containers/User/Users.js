...
export class Users extends Component {
    ...
    updatePage = (rowData, column) => {
        return <Aux> <NavLink to={"update-level/" + rowData.userId} activeClassName="selected">
            ...
            <NavLink to={"user-detail/" + rowData.userId} activeClassName="selected">
                View Detail
            </NavLink>
        </Aux>
    }
    modifyGroup = (rowData, column) => {
        return <Aux> 
        
            <NavLink to={"update-user-group/" + rowData.userId} activeClassName="selected">
                Modify Group 
            </NavLink> 
                    ...
                    <div className="p-col-12">
                        <div className="card card-w-title">
                            ...
                            <DataTable value={this.props.dataTableValue} paginatorPosition="both" selectionMode="single" header="" paginator={true} rows={10}
                                ...
                                <Column  body={this.modifyGroup} header="Modify Group" />                    
